...
const S2_QUIZ = [
  { q: "When Allah says the disbelievers' hearts are \"sealed,\" this means:",
    opts: ["They forgot the Quran","They were born unable to believe","They chose to close their hearts, so Allah sealed them","They are physically deaf"],
    correct: 2 },
  { q: "What is the KEY difference between hypocrites and open disbelievers?",
    opts: ["Hypocrites pray more often","Hypocrites say they believe but don't mean it in their hearts","Hypocrites are less dangerous","Hypocrites read the Quran but disbelievers do not"],
    correct: 1 },
  { q: "In the Fire Parable (2:17), what happened to the hypocrites?",
    opts: ["Their fire burned them","They found a better fire","They ran away safely","Allah took away their light, leaving them in darkness"],
    correct: 3 },
  { q: "When told \"Don't spread corruption,\" the hypocrites replied:",
    opts: ["\"We will try our best\"","\"Forgive us for our mistakes\"","\"WE are only reformers!\"","\"We don't understand\""],
    correct: 2 },
  { q: "According to verse 2:10, what was in the hypocrites' hearts?",
    opts: ["Anger and jealousy","A disease (spiritual sickness)","Fear and sadness","Arrogance and pride"],
    correct: 1 },
];
