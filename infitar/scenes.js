...
window.SCENE_PALETTE = {
  ...
  labelText:'#40d0e8', labelBg:'#020818', labelBar:'#1848a0',  minecraft: {sky0:'#020818',sky1:'#051428',sky2:'#0a1e38',gnd:'#0f2840',gndAcc:'#183050',starStr:'rgba(100,180,255,',acStr:'rgba(64,208,232,',label:'#40d0e8',hint:'#20a8c0'},
...
const VD={
  signs:{ref:'Al-Infitar 82:1-5',arabic:'إِذَا السَّمَاءُ انفَطَرَتْ ۩ وَإِذَا الْكَوَاكِبُ انتَثَرَتْ ۩ وَإِذَا الْبِحَارُ فُجِّرَتْ ۩ وَإِذَا الْقُبُورُ بُعْثِرَتْ ۩ عَلِمَتْ نَفْسٌ مَّا قَدَّمَتْ وَأَخَّرَتْ',english:'"When the sky breaks apart — when the stars scatter — when the seas burst forth — when the graves are overturned — a soul will know what it put forward and left behind." (82:1-5)',note:'Five cosmic signs introduced with "Idha" (When). The conclusion: every soul will know both what it did and what it failed to do.'},
  deceived:{ref:'Al-Infitar 82:6-9',arabic:'يَا أَيُّهَا الْإِنسَانُ مَا غَرَّكَ بِرَبِّكَ الْكَرِيمِ ۩ الَّذِي خَلَقَكَ فَسَوَّاكَ فَعَدَلَكَ ۩ فِي أَيِّ صُورَةٍ مَّا شَاءَ رَكَّبَكَ ۩ كَلَّا بَلْ تُكَذِّبُونَ بِالدِّينِ',english:'"O mankind, what deceived you about your generous Lord — who created you, proportioned you, and balanced you — in whatever form He willed, He assembled you? No! But you deny the Judgement." (82:6-9)',note:'Allah calls Himself "al-Karim" — the Generous. We took His kindness as proof of no accountability. Three acts of creation: khalaqaka (created), sawwaka (proportioned), \'adalaka (balanced). Then the blunt reply: you deny the Day of Recompense.'},
  angels:{ref:'Al-Infitar 82:10-12',arabic:'وَإِنَّ عَلَيْكُمْ لَحَافِظِينَ ۩ كِرَامًا كَاتِبِينَ ۩ يَعْلَمُونَ مَا تَفْعَلُونَ',english:'"Indeed, over you are guardians — noble recorders — who know everything you do." (82:10-12)',note:'Kiraman Katibin — Noble Recording Angels. Three qualities: hafizin (guardians), kiram (noble), they know every deed. Your record is in honoured hands.'},
  destiny:{ref:'Al-Infitar 82:13-16',arabic:'إِنَّ الْأَبْرَارَ لَفِي نَعِيمٍ ۩ وَإِنَّ الْفُجَّارَ لَفِي جَحِيمٍ ۩ يَصْلَوْنَهَا يَوْمَ الدِّينِ ۩ وَمَا هُمْ عَنْهَا بِغَائِبِينَ',english:'"The righteous will be in bliss — the wicked will be in Hell — entering it on the Day of Recompense — and they will not be absent from it." (82:13-16)',note:'Two absolute destinies. Al-Abrar in na\'im (bliss). Al-Fujjar in jahim (Hell). And the chilling ending: they will NOT be absent from it.'},
  yawm:{ref:'Al-Infitar 82:17-19',arabic:'وَمَا أَدْرَاكَ مَا يَوْمُ الدِّينِ ۩ ثُمَّ مَا أَدْرَاكَ مَا يَوْمُ الدِّينِ ۩ يَوْمَ لَا تَمْلِكُ نَفْسٌ لِّنَفْسٍ شَيْئًا وَالْأَمْرُ يَوْمَئِذٍ لِّلَّهِ',english:'"What will make you know what the Day of Recompense is? Then what will make you know what the Day of Recompense is? A Day when no soul has power for another — and the command is entirely for Allah." (82:17-19)',note:'The question asked TWICE — it defies comprehension. No soul helps another. All authority returns to Allah alone.'},
};
