...
const S2_QUIZ=[
  {q:'What is "al-Ukhdud" (الأُخْدُود) mentioned in 85:4?',opts:['A type of weapon used against believers','A DITCH/TRENCH — "ukhdud" means a long, deep trench dug into the earth. The tyrant had trenches filled with fuel and fire dug specifically to throw believers into them as punishment for their faith.','A prison tower in ancient Arabia','A mountain pass where believers were trapped'],correct:1},
  {q:'What were the persecutors doing while believers burned (85:6-7)?',opts:['They were hiding from Allah\'s punishment','They were SITTING (qu\'ud) over the trenches — literally sitting at the edges of the burning pits, WATCHING (shuhud) what they were doing to the believers. They were deliberate, public witnesses to their own atrocity.','They were fleeing from the scene','They were trying to convince the believers to recant'],correct:1},
  {q:'The historical event is the persecution by Dhunuwas of Yemen. What happened to these believers?',opts:['They were eventually saved by a Muslim army','The believers who refused to abandon their faith were burned alive in the trenches. They chose death over betrayal of their faith. Islamic tradition says they entered Paradise directly — "Al-Fawz al-Kabir."','They were enslaved and eventually released','They escaped and founded a new community'],correct:1},
  {q:'What does "Qutila ashab al-ukhdud" (85:4) — "DESTROYED were the people of the ditch" — refer to?',opts:['The believers who were thrown into the ditch were destroyed','The word "qutila" is a curse — meaning "may they be killed/cursed!" — referring to the PERSECUTORS (the people who dug and maintained the ditch). They are cursed and destroyed for what they did to the believers.','The ditch itself was destroyed','Both the believers and persecutors are referred to'],correct:1},
];

const S3_QUIZ=[
  {q:'What was the ONLY reason the believers were persecuted (85:8)?',opts:['They attacked the king\'s army','They refused to pay taxes to the tyrant','"Wa ma naqamu minhum illa an yu\'minu bi-Allah al-Aziz al-Hamid" — They resented them for NOTHING except that they believed in Allah, the Exalted in Might, the Praiseworthy. Pure faith was their only "crime."','They preached loudly in public and disturbed the peace'],correct:1},
  {q:'Why does Allah specifically mention "al-Aziz" (Mighty) and "al-Hamid" (Praiseworthy) in 85:8?',opts:['Because these are the two most important names of Allah','The believers chose to believe in "al-Aziz" — the Most Powerful, Most Invincible — despite being apparently powerless before the tyrant. They chose to praise "al-Hamid" — the Most Praiseworthy — while being tortured. These names show the irony: the tyrant had earthly power, but the believers held onto THE Powerful and THE Worthy of Praise.','Because these names specifically protect against fire','Because the people of Yemen only believed in these two attributes'],correct:1},
  {q:'"Wa Allah \'ala kulli shay\'in shahid" (85:9) — "Allah is witness over everything." What does this mean in context?',opts:['Allah is just watching without intervening','The tyrants thought they were acting unseen or unpunished. Allah declares: I am WITNESS to everything. Every burning. Every scream. Every act of oppression. And being Allah the Witness — perfect justice WILL come. Nothing done in darkness escapes His sight.','Allah watches only the believers, not the oppressors','Allah witnesses only important events'],correct:1},
  {q:'What is the deeper lesson about persecution of believers throughout history?',opts:['Believers should always physically fight back immediately','The Quran shows that believers have always been persecuted — the Ukhdud, Pharaoh, Thamud, and the early Muslims. The pattern is: oppressors seem to win in this world, but "Allah surrounds them from behind" (85:20). The believers\' reward is the Greatest Attainment.','Believers should find political power before practicing publicly','Allah prevents all persecution of believers in this world'],correct:1},
];
