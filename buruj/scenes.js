...
class S5 extends BS{constructor(){super('canvas-5');}start(){if(!this.ctx)return;this.canvas.onclick=()=>showVersePopup(VD.attainment);const draw=()=>{this.t++;this.raf=requestAnimationFrame(draw);const ctx=this.ctx,p=sceneP();
...
class S6 extends BS{constructor(){super('canvas-6');}start(){if(!this.ctx)return;this.canvas.onclick=()=>showVersePopup(VD.watching);const draw=()=>{this.t++;this.raf=requestAnimationFrame(draw);const ctx=this.ctx,p=sceneP();_sky(ctx);_stars(ctx,12);_ground(ctx,175);_label(ctx,'CLICK: Allah\'s Grip is Severe — 85:12-20');
// Tyrant falling
...
const VD={
  attainment:{ref:'Al-Buruj 85:11',arabic:'إِنَّ الَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ لَهُمْ جَنَّاتٌ تَجْرِي مِن تَحْتِهَا الْأَنْهَارُ ۚ ذَٰلِكَ الْفَوْزُ الْكَبِيرُ',english:'"Indeed, those who have believed and done righteous deeds will have gardens beneath which rivers flow. That is the great attainment." (85:11)',note:'The believers who were burned on earth receive gardens with rivers — "al-Fawz al-Kabir" (the Great Attainment). The contrast is deliberate: earthly fire below → heavenly rivers below. The reversal is complete.'},
  ...
  watching:{ref:'Al-Buruj 85:12-20',arabic:'إِنَّ بَطْشَ رَبِّكَ لَشَدِيدٌ ۩ إِنَّهُ هُوَ يُبْدِئُ وَيُعِيدُ ۩ وَهُوَ الْغَفُورُ الْوَدُودُ ۩ ذُو الْعَرْشِ الْمَجِيدُ ۩ فَعَّالٌ لِّمَا يُرِيدُ ۩ هَلْ أَتَاكَ حَدِيثُ الْجُنُودِ ۩ فِرْعَوْنَ وَثَمُودَ ۩ بَلِ الَّذِينَ كَفَرُوا فِي تَكْذِيبٍ ۩ وَاللَّهُ مِن وَرَائِهِم مُّحِيطٌ',english:'"Indeed, the grip of your Lord is severe. Indeed, it is He who originates and repeats. And He is the Forgiving, the Loving — Owner of the Glorious Throne — Effecter of what He intends. Has there reached you the story of the soldiers? Of Pharaoh and Thamud? But they who disbelieve are in persistent denial — while Allah encompasses them from behind." (85:12-20)',note:'Nine verses declaring Allah\'s power. His grip is severe (12), He originates and repeats creation (13), He is the Forgiving and Loving (14), Owner of the Glorious Throne (15), Effecter of what He intends (16). Historical proof: Pharaoh and Thamud (17-18) — mighty armies, all destroyed. Yet the disbelievers persist in denial (19) while Allah encompasses them completely from behind (20).'},
