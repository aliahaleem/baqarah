...
const REWARDS = {
  1:{xp:70, gems:3, icon:'🌊', title:'Al-Kawthar Known', msg:"SubhanAllah! Al-Kawthar is a river in Jannah — whiter than milk, sweeter than honey, with cups like stars. And 'Al-Kawthar' also means 'abundant good' — the billions who follow the Prophet ﷺ, the Quran that will last forever!"},
  2:{xp:80, gems:3, icon:'🙏', title:'Gratitude Shown',  msg:"MashAllah! Allah gave the Prophet ﷺ Al-Kawthar — so pray to your Lord and sacrifice. Salah and sacrifice as gratitude for such abundance. When was the last time you made salah as pure thankfulness?"},
  3:{xp:90, gems:4, icon:'✂️', title:'Al-Kawthar Complete', msg:"Allahu Akbar! Al-Kawthar complete! 'Inna shani\'aka huwul-abtar.' Your enemy is the one cut off — not you! The enemies of the Prophet ﷺ who mocked his sons dying are forgotten. Muhammad ﷺ is remembered by 2 billion+ people! Ameen! 🏆"},
};

window.SURAH_CONFIG = {
  id:'s108', surahName:'Al-Kawthar', surahArabic:'الكوثر', totalLevels:3, rewards:REWARDS,
  tileIcons:['🌊','🙏','✂️'], tileLabels:['Al-Kawthar','Pray & Sacrifice','Abtar'],
  welcomeMsg:{
    fresh:   n=>`As-salamu alaykum, ${n}! Surah Al-Kawthar — Abundance! The shortest surah in the Quran — 3 verses — but what a message! Allah gave the Prophet ﷺ Al-Kawthar (a river in Jannah + abundant good). His enemies are the ones who are forgotten! 3 levels!`,
    partial: (n,d)=>`Welcome back, ${n}! ${d}/3 done. The river flows! 🌊`,
...
window._drawBuildCanvas = function(n) {
  ...
  ctx.fillText(n>=3?'AL-KAWTHAR COMPLETE! 🌊':`Al-Kawthar — ${n}/3 levels`,W/2,14);ctx.textAlign='left';
};
