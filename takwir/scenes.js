...
const VD={
  ...
  oath:{ref:'At-Takwir 81:15-18',arabic:'فَلَا أُقْسِمُ بِالْخُنَّسِ ۩ الْجَوَارِ الْكُنَّسِ ۩ وَاللَّيْلِ إِذَا عَسْعَسَ ۩ وَالصُّبْحِ إِذَا تَنَفَّسَ',english:'"I swear by the retreating stars — those that run their course and hide — and the night when it departs — and the dawn when it breathes." (81:15-18)',note:'Al-Khunnas — the stars that retreat and hide during the day, reappearing at night. Allah swears by the retreating planets and the cycle of night and dawn to introduce the most important declaration: the Quran is truly from Him.'},
