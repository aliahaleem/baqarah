...
window.state = { explorerName:'', xp:0, gems:0, completed:[], s1Answers:{}, s1Checked:false, s2Order:[], s2Checked:false, s3Checked:false, s4Answers:{}, s4Checked:false };

const REWARDS = {
  1:{xp:70, gems:3, icon:'💥', title:'Hour Strikes',   msg:"SubhanAllah! 'Al-Qaria! Mal-Qaria? Wa ma adraka mal-Qaria?' The Striking Hour! What is the Striking Hour? And what can make you know what it is? The repetition builds dread — this is coming, and it is MORE than you can imagine!"},
  2:{xp:80, gems:3, icon:'📋', title:'Story Ordered',  msg:"MashAllah! You ordered the Day of Al-Qaria correctly — from the strike to the scattered moths to the carded wool to the weighing of the scales!"},
  3:{xp:85, gems:3, icon:'⚖️', title:'Scales Known',   msg:"SubhanAllah! Heavy scales → comfortable life in high Jannah. Light scales → the abyss of Hawiyah — whose mother is a blazing fire! Two outcomes. Two eternities!"},
  4:{xp:100, gems:4, icon:'🔥', title:'Al-Qaria Complete', msg:"Allahu Akbar! Al-Qaria complete! 'Ummuhul hawiyah — wa ma adraka ma hiyah — narun hamiyah.' May Allah protect us from the fire that blazes and may our scales be heavy with good deeds! Ameen! 🏆"},
};

window.SURAH_CONFIG = {
  id:'s101', surahName:'Al-Qaria', surahArabic:'القارعة', totalLevels:4, rewards:REWARDS,
  tileIcons:['💥','📋','⚖️','🔥'], tileLabels:['The Strike','Story Order','The Scales','Hawiyah'],
  welcomeMsg:{
    fresh:   n=>`As-salamu alaykum, ${n}! Surah Al-Qaria — The Striking Hour! The Day strikes like a hammer. People scatter like moths. Mountains become fluffed wool. Then the scales: heavy = Jannah. Light = Hawiyah (Hellfire). 4 levels!`,
    partial: (n,d)=>`Welcome back, ${n}! ${d}/4 done. The scales await! ⚖️`,
...
window._drawBuildCanvas = function(n) {
  ...
  ctx.fillText(n>=4?'AL-QARIA COMPLETE! ⚖️':`Al-Qaria — ${n}/4 levels`,W/2,14);ctx.textAlign='left';
};
